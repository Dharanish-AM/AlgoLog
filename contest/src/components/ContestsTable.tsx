        ...
        <table className="w-full">
          <thead className="bg-slate-700 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap">Contest</th>
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-left text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap hidden lg:table-cell">Start Time</th>
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap hidden md:table-cell">Duration</th>
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap">Type</th>
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-center text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap">Participants</th>
              <th className="px-3 sm:px-6 py-3 sm:py-4 text-right text-xs font-medium text-slate-300 uppercase tracking-wider whitespace-nowrap">Action</th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="px-3 sm:px-6 py-3 sm:py-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-2 h-2 rounded-full ${contest.virtual ? 'bg-purple-500' : 'bg-blue-500'}`}></div>
                    <div>
                      <div className="text-sm font-medium text-white truncate max-w-48 sm:max-w-none">{contest.title}</div>
