...
export default function EditStudentModal({ isOpen, onClose, onSave, student }) {
  ...
  useEffect(() => {
    if (student) {
      const departmentId = student.department && typeof student.department === "object"
  ...
  return (
    <div className="fixed inset-0 w-screen h-screen bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white scrollbar-hide dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-xl max-h-[90vh] overflow-y-auto relative">
