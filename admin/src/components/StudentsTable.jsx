              ...
              >
                ...
                <td className="px-3 sm:px-6 py-3 sm:py-4">
                  <div>
                    ...
                    <div className="text-xs sm:text-sm text-slate-400 hidden sm:block">
                      {student.department?.name} • Class {student.class} •{" "}
                      {student.year}
                    </div>
                ...
                <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-center">
                  <div className="text-sm text-white font-semibold mb-1">
                    {student.problemsSolved?.total ?? 0}
                  </div>
                ...
                <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-center text-sm text-slate-300 hidden lg:table-cell">
                  {(student.globalRank ?? 0).toLocaleString()}
                </td>
